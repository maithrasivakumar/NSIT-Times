      ...
      children: <Widget>[
        Container(
          ...
          child: Column(
            children: <Widget>[
              Padding(
                padding: EdgeInsets.fromLTRB(0, 0, 194, 0),
              ),
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushNamed(TerScreen.tag);
                  },
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushNamed(QuatScreen.tag);
                  },
                  padding: EdgeInsets.all(0),
                  color: Colors.white,
                  splashColor: Colors.black12,
